...
namespace Web_ProjectName.Middlewares
{
    public class SecurityHeadersMiddleware
    {
        ...
        public Task Invoke(HttpContext context)
        {
            try
            {
                ...
                //if (context.Response.ContentType == "text/css" || context.Response.ContentType == "text/js")
                //{
                ...
                // You can use https://report-uri.com/ to get notified when a misjournald certificate is detected
