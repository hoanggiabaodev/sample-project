...
{
    public class M_ProjectCategory : M_BaseModel.BaseCustom
    {
        ...
        public List<M_ProjectCategory> children { get; set; }
    }
    public class EM_ProjectCategory : M_BaseModel.BaseCustom
    {
        public int? id { get; set; }
        public int? parentId { get; set; }
        public int? supplierId { get; set; }
