...
{
    public class M_Project : M_BaseModel.BaseCustom
    {
        ...
        public M_ProjectCategory projectCategoryObj { get; set; }
    ...
    public class EM_Project : M_BaseModel.BaseCustom
    {
        public int? id { get; set; }
        ...
        public bool isHot { get; set; }
        public int? viewNumber { get; set; }
        [StringLength(250, ErrorMessage = "Chủ đầu tư tối đa 250 ký tự!")]
        public string investor { get; set; }
        public int? addressId { get; set; }
        public DateTime? startDate { get; set; }
        public DateTime? endDate { get; set; }
        ...
        public int? imageId { get; set; }
        public string imageList { get; set; }
        [StringLength(200, ErrorMessage = "Video tối đa 200 ký tự!")]
        public string videoUrl { get; set; }
        ...
        [DataType(DataType.Upload)]
        [MaxFile(maxFile: 5, errorMessage: "Giới hạn tải lên tối đa 5 ảnh!")]
        [MaxFileSizeInList(maxFileSize: Lib.CommonConstants.MAX_FILE_SIZE_IMAGE_UPLOAD * 1024 * 1024, errorMessage: "Dung lượng ảnh tối đa 5MB!")]
